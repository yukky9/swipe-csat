...
import LightGeneralPage from "../components/pages/GeneralPage/LightGeneralPage";
	...
	return (
		<BrowserRouter>
			<Routes>
				...
				<Route
					path="/createPolls"
					element={<FirstCreatePollsFormPage />}
				/>
				<Route
					path="/createPattern"
					element={<CreatePatternFormPage />}
				/>
				<Route
					path="/generatePattern"
					element={<GeneratePatternFormPage />}
				/>
				<Route
					path="/editCreateByPattern"
					element={<VariantCreateFormModal />}
				/>
			</Routes>
		</BrowserRouter>
	);
